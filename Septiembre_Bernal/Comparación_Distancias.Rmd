...
output75 <- cov.mcd(x, quantile.used = nrow(x)*.75)
mhmcd75 <- mahalanobis(x, output75$center, output75$cov)
cutoff <- (qchisq(p = 1 - alpha, df = ncol(x)))
names_outlier_MCD75 <- which(mhmcd75 > cutoff)
excluded_mcd75 <- names_outlier_MCD75
data_clean_mcd <- x[-excluded_mcd75, ]
x[excluded_mcd75, ]
