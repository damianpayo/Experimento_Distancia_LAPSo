...
ggplot(data_clean %>% filter(freq == '4k'), aes(x=dist_log, y=resp_log, color=condicion)) +
  ...
  theme_minimal()
```
### FALTA data_prom tibble with means and std per condition
...
### Modelo mixto agregando predictores 

(sugerencia de nacho luego de una corrección que le hicieron en un trabajo)
